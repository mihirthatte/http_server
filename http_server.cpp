...
void handle_client(struct sockaddr_in client_details, int client_socket){
	cout << "Connection from client " << inet_ntoa(client_details.sin_addr)<< " port - "<<ntohs(client_details.sin_port)<<endl<<client_socket<<endl;
...
int main(int argc, char *argv[]){
    ...
    while(1){
        ...
        cout<<"new req from client "<<delegate_socket<<endl;
